...
## React Forms
React makes use of forms to enable user interaction with the website.
```
...
## Redux 
Redux is a state management library that is often used with React to handle the state of your application. An application state is like a global object which holds information that you use for various purposes later in the app.
```
